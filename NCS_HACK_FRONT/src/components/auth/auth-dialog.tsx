            ...
            {stage === "auth" ? (
              <div className="space-y-4">
                ...
                <Button
                  ...
                  className="h-11 w-full rounded-[1rem] bg-[#291c08] text-sm text-white hover:bg-[#1d1406] disabled:opacity-50"
                >
                  {authLoading ? "Chargement..." : isSignup ? "Continuer" : "Se connecter"}
                </Button>
              </div>
            ) : (
              <div className="space-y-4">
