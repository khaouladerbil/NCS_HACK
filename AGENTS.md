...
JusticePath is a React/Vite civic legal guidance interface. Keep work grounded in `MEMORY.md` and the JusticePath design system.

## Operating Rules

- Update `MEMORY.md` after every prompt with durable decisions, blockers, and verification.
...
- For user-facing screens, verify the browser surface when possible.
